...
if __name__ == "__main__":
    ...
    source_directory = "/mnt/f/marinum/prokka_output"
    destination_directory = "/mnt/f/marinum/prokka_generated_gff/"
    ...
    file_extension = ".gff"  # Change this to any other extension as needed
